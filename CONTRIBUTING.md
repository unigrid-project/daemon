Contributing to HUZU Core
============================

The HUZU Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HUZU Core project, and is not to be
confused with overall HUZU Network Protocol consensus changes.

Whether a pull request is merged into HUZU Core rests with the project merge
...
Patches that change HUZU consensus rules are considerably more involved than
...
Where a patch set proposes to change the HUZU consensus, it must have been
...
The project leader is the release manager for each HUZU Core release.
