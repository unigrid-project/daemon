...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"To use HUZUd, or the -server option to HUZU-qt, you must set an "
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Unable to bind to %s on this computer. HUZU Core is probably already "
"running."),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) 2009-%i The Bitcoin Core and HUZU Core Developers"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of HUZU Core"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Fee (in HUZU/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. HUZU Core is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart HUZU Core to complete"),
