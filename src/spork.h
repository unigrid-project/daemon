...
#define SPORK_5_MAX_VALUE_DEFAULT 1000                            //1000 HUZU
...
#define SPORK_17_NEW_DEVFUND_ENFORCEMENT_DEFAULT 4070908800       //OFF
#define SPORK_18_BLACKLIST_BLOCK_REFERENCE_DEFAULT -1             //OFF
