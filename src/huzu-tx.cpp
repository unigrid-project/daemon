...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Huzu Core huzu-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  huzu-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded huzu transaction") + "\n" +
                               "  huzu-tx [options] -create [commands]   " + _("Create hex-encoded huzu transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded huzu transaction
