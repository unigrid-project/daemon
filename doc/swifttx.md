...
This mechanism has been integrated into Bitcore-Node-HUZU which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/HUZU-Project/insight-api-huzu#web-socket-api](https://github.com/HUZU-Project/insight-api-huzu#web-socket-api) 
* API: [https://github.com/HUZU-Project/insight-api-huzu#swifttx-transactions](https://github.com/HUZU-Project/insight-api-huzu#swifttx-transactions) 
...
By default, the HUZU Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the HUZU Core daemon:
