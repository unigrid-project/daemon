...
In order to support loading of multiple wallets in huzu-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is huzu.cpp.
...
Changes to huzu.cpp
----------------------
huzu.cpp is the entry point into huzu-qt, and as such, will require some minor modifications to provide hooks for
