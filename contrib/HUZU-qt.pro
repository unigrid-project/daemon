...
RESOURCES += src/qt/huzu.qrc src/qt/huzu_locale.qrc

TRANSLATIONS += src/qt/locale/huzu_bg.ts \
                src/qt/locale/huzu_de.ts \
                src/qt/locale/huzu_en.ts \
                src/qt/locale/huzu_es.ts \
                src/qt/locale/huzu_fi.ts \
                src/qt/locale/huzu_fr.ts \
                src/qt/locale/huzu_it.ts \
                src/qt/locale/huzu_ja.ts \
                src/qt/locale/huzu_pl.ts \
                src/qt/locale/huzu_pt.ts \
                src/qt/locale/huzu_ru.ts \
                src/qt/locale/huzu_sk.ts \
                src/qt/locale/huzu_sv.ts \
                src/qt/locale/huzu_vi.ts \
                src/qt/locale/huzu_zh_CN.ts \
                src/qt/locale/huzu_zh_TW.ts
